        ...
        <div className="mb-12 flex items-center justify-between bg-gradient-to-br from-primary/10 via-primary/5 to-background rounded-3xl p-8 border border-primary/20">
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full border border-primary/20">
              ...
              <span className="text-sm font-medium text-primary">Tableau de bord Admin</span>
            </div>
            <div>
              ...
              <p className="text-muted-foreground">
                Gérez les médecins, supervisez les rendez-vous et suivez la performance de votre cabinet dentaire.
              </p>
            </div>
          </div>
