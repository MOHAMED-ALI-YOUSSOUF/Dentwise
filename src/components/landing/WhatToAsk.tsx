        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight">
            ...
            <span className="bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
              tout ce qui concerne les dents
            </span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Des questions simples aux préoccupations complexes, notre IA fournit des conseils de
            niveau expert basés sur des milliers de cas dentaires réels.
          </p>
        </div>

        <div className="grid lg:grid-cols-2 gap-16 items-start">
          {/* CÔTÉ GAUCHE - Exemples de conversations */}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-3 flex-1">
                      <div className="bg-primary/5 rounded-2xl p-4 border border-primary/10">
                        <p className="font-semibold text-primary">« J’ai mal quand je croque avec une dent »</p>
                      </div>
                      <div className="bg-muted/30 rounded-2xl p-4">
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Obtenez des conseils immédiats sur la gestion de la douleur, les causes possibles
                          et quand consulter un dentiste en urgence.
                        </p>
                ...
                <div className="bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-6 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-3 flex-1">
                      ...
                      <div className="bg-muted/30 rounded-2xl p-4">
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Comparez les différentes options de traitement, les gammes de prix et trouvez la
                          meilleure solution adaptée à votre budget.
                        </p>
                        <div className="flex gap-2 mt-3">
                          <span className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">
                            Analyse de coût
              ...
              <div className="group relative">
                <div className="bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-6 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-3 flex-1">
                      <div className="bg-primary/5 rounded-2xl p-4 border border-primary/10">
                        <p className="font-semibold text-primary">« Quand faut-il remplacer un plombage ? »</p>
                      </div>
                      <div className="bg-muted/30 rounded-2xl p-4">
                        <p className="text-sm text-muted-foreground leading-relaxed">
                          Découvrez la durée de vie d’un plombage, les signes d’usure et quand prévoir un
                          remplacement.
                        </p>
                        <div className="flex gap-2 mt-3">
                          <span className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">
