          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10">
                ...
                <span className="text-xs font-medium text-primary">Toujours prêt pour vous</span>
              </div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Rejoignez plus de 1 200 patients qui font confiance à notre IA pour des conseils
                instantanés et un suivi personnalisé.
              </p>
            </div>
