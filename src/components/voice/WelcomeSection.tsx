  ...
  return (
    <div className="z-10 flex items-center justify-between bg-gradient-to-br from-primary/10 via-primary/5 to-background rounded-3xl p-8 border border-primary/20 mb-12 overflow-hidden">
      <div className="space-y-4">
        ...
        <div>
          <h1 className="text-4xl font-bold mb-2">Assistant Vocal IA</h1>
          <p className="text-muted-foreground">
            Parlez à votre assistant dentaire intelligent avec des commandes vocales naturelles.
            Obtenez des conseils instantanés et un accompagnement professionnel.
          </p>
        </div>
      </div>
