            ...
            <div className="relative z-10 flex items-center justify-between">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full border border-primary/20">
                  ...
                  <span className="text-sm font-medium text-primary">Fonctionnalité Pro</span>
                </div>
                <div>
                  <h1 className="text-4xl font-bold mb-2">
                    Accès à l’assistant vocal requis
                  </h1>
                  <p className="text-muted-foreground">
                    Passez à <strong>AI Pro</strong> ou <strong>AI Basic</strong> pour débloquer les
                    consultations vocales illimitées avec notre assistant dentaire intelligent.
                  </p>
                </div>
              </div>
        ...
        <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30 max-w-2xl mx-auto">
          <CardContent className="relative p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              La fonction d’assistant vocal est disponible uniquement pour les abonnés{" "}
              <strong>AI Pro</strong> et <strong>AI Basic</strong>. Obtenez des conseils dentaires
              instantanés grâce à des conversations vocales naturelles.
            </p>

            <div className="space-y-4 mb-6">
              <div className="flex items-center gap-3 justify-center">
                <div className="w-2 h-2 bg-primary rounded-full"></div>
                <span className="text-sm">Consultations vocales 24h/24 et 7j/7</span>
              </div>
              <div className="flex items-center gap-3 justify-center">
                <div className="w-2 h-2 bg-primary rounded-full"></div>
              ...
              <div className="flex items-center gap-3 justify-center">
                <div className="w-2 h-2 bg-primary rounded-full"></div>
                <span className="text-sm">Recommandations instantanées pour soulager la douleur</span>
              </div>
            </div>
